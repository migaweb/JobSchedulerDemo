    ...
    public static void ConfigureQuartzSchedulerServices(this IServiceCollection services, IConfiguration configuration)
    {
      ...
      services.AddQuartz(q =>
      {
        ...
        q.UsePersistentStore(s =>
        {
          ...
          //s.UseClustering(options => {
          //  options.CheckinInterval()
          //});
          s.RetryInterval = TimeSpan.FromSeconds(15);
          s.UseSqlServer(sqlServer =>
          {
            sqlServer.ConnectionString = "Data Source=hangfiredb;Initial Catalog=hangfire-webapi-db;Integrated Security=False;User ID=sa;Password=abc1234_Q;Pooling=False";
            // this is the default
